...
export class Card {
  ...
  @ApiProperty({
    type: String,
    required: false,
    example: 'if the card is team type,assigned to member in team',
  })
  ...
  @ApiProperty({ type: String, required: true, example: 'http://image.png' })
  ...
  @ApiProperty({
    type: String,
    required: false,
    example: 'bedomohamed307@gmail.com',
  })
  @Prop({ required: false, type: String })
  email?: string;
  ...
  @ApiProperty({
    ...
    required: false,
    example: '#ffffff',
    description: 'By default its #ffffff',
  })
  ...
  @ApiProperty({
    type: CardQrImageView,
    required: false,
    description: 'Qr Image View data for rendering in flutter',
    example: {
      data: 'http://link.com',
      embededImage: 'http://linqit/logo.com',
      size: 100,
    },
  })
